...
private Document document;
	...
	public static void main(String[] args) throws DocumentException {
		...
		String filepath ="D:\\Workspaces\\MyEclipseProfessional2014\\myguice\\MyXml.xml";
		AddDeleteXML operator = new AddDeleteXML(filepath);
		operator.createXMLFile("aaa");
		operator.getXmlFile();
...
//		operator.deleteChildOne("style", "","div","div11");
	...
	public  AddDeleteXML(String filepath){
		this.document = null;
